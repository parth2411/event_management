...
ResultSet rs=null;
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon("C:\\Users\\owner\\Desktop\\icon\\icons8_Audience_96px_1.png")); // NOI18N
        jLabel5.setText("Shows");
        ...
        jPanel1.add(e1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 120, 170, 40));
        ...
        jPanel1.add(e3, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 120, 200, 40));
        ...
        addnew.add(sname, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 40, 220, 30));
        ...
        addnew.add(sid, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 160, 220, 30));
        addnew.add(st, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 220, 220, 30));
        addnew.add(et, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 280, 220, 30));
        ...
        addnew.add(jTextField8, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 40, 220, 30));

        jLabel19.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(255, 255, 255));
        jLabel19.setText("Cost:-");
        addnew.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 40, -1, 34));
        ...
        jLabel6.setText("Enter Show Name:-");
        ...
        update.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 40, 230, 30));
        ...
        update.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 40, -1, -1));
        update.add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 110, 220, 30));

        jLabel7.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText(" Show Name:-");
        update.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, -1, 34));

        jLabel8.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText(" Event ID:-");
        update.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, -1, 34));
        ...
        update.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 170, 220, 30));

        jLabel4.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText(" Show ID:-");
        update.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, -1, 34));
        update.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 230, 220, 30));

        jLabel3.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText(" Start Time:-");
        update.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 290, -1, 34));
        update.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 290, 220, 30));

        jLabel2.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText(" End Time:-");
        update.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 110, -1, 34));
        update.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 110, 220, 30));
        ...
        update.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 230, 150, -1));
        ...
        update.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 280, 150, -1));

        jLabel18.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(255, 255, 255));
        jLabel18.setText("Cost:-");
        update.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 170, -1, 34));
        update.add(c, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 170, 220, 30));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Event ID", "Show Name", "Show ID", "Start Time", "End Time", "Cost"
            }
        ) {
        ...
        list.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1, 85, 890, 280));

        jLabel20.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        jLabel20.setForeground(new java.awt.Color(36, 47, 65));
        jLabel20.setText("Enter Event Name:-");
        list.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 20, -1, 30));
    ...
    private void e1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_e1MouseClicked
        ...
        try
        {
            String q ="Select * from shows;";
            stm = connect.createStatement();
            rs = stm.executeQuery(q);
            while(rs.next())
            {
                int  a1;
                a1 = rs.getInt("event_id");
                String a2 = rs.getString("show_name");
                int a3 = rs.getInt("show_id");
                String a4 = rs.getString("start_time");
                String a5 = rs.getString("end_time");
                
                String a6 = rs.getString("cost");
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        try
        {
            String ename1= sname.getText();
            String ename2= eid.getText();
            String ename3= sid.getText();
            String ename4= st.getText();
            String ename5= et.getText();
            String ename6= jTextField8.getText();

            String q = "insert into shows(show_id,show_name,start_time,end_time,event_id,cost) values('"+ename3+"','"+ename1+"','"+ename4+"','"+ename5+"','"+ename2+"','"+ename6+"')";
            stm=connect.createStatement();
            stm.executeUpdate(q);
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if(key.isEmpty())
        {
            JOptionPane.showMessageDialog(null, "Enter show Name to be searched !!");
        }
        else
        {
            try
            {
                ...
                while(rs.next())
                {
                    jTextField6.setText(rs.getString("show_name"));
                    jTextField2.setText(rs.getString("event_id"));
                    jTextField3.setText(rs.getString("show_id"));
                    jTextField4.setText(rs.getString("start_time"));
                    jTextField5.setText(rs.getString("end_time"));
    ...
    private void jLabel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseClicked
        ...
        try
        {
            String q = "update shows set show_name='"+a1+"',event_id='"+a2+"',show_id='"+a3+"',start_time='"+a4+"',end_time='"+a5+"',cost='"+a6+"' where show_name='"+key+"'";
            stm = connect.createStatement();
            stm.executeUpdate(q);
    ...
    private void jLabel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseClicked
        ...
        try
        {
            String q = "delete from shows where show_name='"+key+"';";
            stm = connect.createStatement();
            stm.executeUpdate(q);
...
if(key.isEmpty())
{
    JOptionPane.showMessageDialog(null,"Enter show Name to search");
}
else
{
    DefaultTableModel table = (DefaultTableModel) jTable1.getModel();
